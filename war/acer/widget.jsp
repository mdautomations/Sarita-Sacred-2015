...
<li><a href="typography.jsp">Typography</a></li>
                    <li class="active"><a href="widget.jsp">Widget</a></li>
            ...
            <div class="col-md-8">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <section class="panel">
                            <div class="wdgt-row">
                                <img src="images/weather_image.jpg" alt="">
                                <div class="wdt-head">
                                    weather forecast
                                </div>
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <div class="row m-bot20">
                            <div class="col-md-7 col-xs-7">Cellular Data</div>
                        ...
                        <div class="row m-bot20">
                            <div class="col-md-7 col-xs-7">Bluetooth</div>
                            <div class="col-md-5 col-xs-5">
                        ...
                        <div class="row m-bot20">
                            <div class="col-md-7 col-xs-7">Wifi Service</div>
                            <div class="col-md-5 col-xs-5">
                    ...
                    <div class="row prd-row">
                        <div class="col-md-6">
                            ...
                            <div class="action">
                                ...
                                <a href="#" class="part1 yellow-bg-prd">
                        ...
                        <div class="col-md-6">
                            <h1>Boxing Gloves</h1>
                            <p class="normal">Red Color Leather globe</p>
                            <p class="terques">Sports</p>
                            <div class="price">
                                <div class="amnt">$49</div>
                                <p>Per Pair</p>
                            </div>
                        </div>
                        <a href="#" class="btn btn-primary pull-right btn-add-cart">Add to Cart</a>
