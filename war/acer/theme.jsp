...
<head>
    ...
    <![endif]-->
    <!--Theme-->
    <link id="themes" rel="stylesheet" href="css/default-theme.css" type="text/css">
</head>
<body>
...
<div class="theme-switcher">
    ...
    <ul class="color-list clearfix">
        <li title="default-theme" class="theme-color default-theme"></li>
        <li title="blue-theme" class="theme-color blue-theme"></li>
        <li title="green-theme" class="theme-color green-theme"></li>
        <li title="orange-theme" class="theme-color orange-theme"></li>
        <li title="purple-theme" class="theme-color purple-theme"></li>
        <li title="turquoise-theme" class="theme-color turquoise-theme"></li>
    </ul>

    <!--<h6>Layout Option</h6>-->
    <!--<ul class="select-layout layout-option clearfix">-->
        <!--<li><button class="btn btn-default btn-info fluid-layout">Fluid</button><button class="btn btn-default btn-info box-layout">Boxed</button></li>-->
    <!--</ul>-->
</div>
    ...
    <header class="header fixed-top clearfix">
        ...
        <div class="top-nav clearfix">
            ...
            <ul class="nav pull-right top-menu">
                <li>
                    <a class="gear-settings" href="#"><i class="ico-palette2"></i></a>
                </li>
                <li>
...
<li><a href="typography.jsp">Typography</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a href="advanced_form.jsp">Advanced Components</a></li>
...
<!-- sidebar menu end-->
                    ...
                    <div class="monthly-stats pink">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="bar-chart">
                                <div class="sparkline" data-type="bar" data-resize="true" data-height="75" data-width="90%" data-bar-color="#fff" data-bar-width="10" data-data="[300,200,500,700,654,987,457,300,876,454,788,300,200,500,700,654,987,457,300,876,454,788]"></div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="row">
        <div class="col-md-8">
            <section class="panel">
                <div class="wdgt-row">
                    <img src="images/weather_img.png" height="243" alt="">
                    <div class="wdt-head">
                        weather forecast
                    </div>
