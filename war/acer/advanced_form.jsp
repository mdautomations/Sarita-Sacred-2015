    ...
    <div id="sidebar" class="nav-collapse">
        <!-- sidebar menu start-->            <div class="leftside-navigation">
            ...
            <li class="sub-menu">
                ...
                <ul class="sub">
                    <li><a href="boxed_page.jsp">Boxed Page</a></li>
                    <li><a href="horizontal_menu.jsp">Horizontal Menu</a></li>
                    <li><a href="language_switch.jsp">Language Switch Bar</a></li>
                </ul>
            </li>
            <li class="sub-menu">
                <a href="javascript:;">
...
<li><a href="typography.jsp">Typography</a></li>
                    <li><a href="widget.jsp">Widget</a></li>
                    <li><a href="slider.jsp">Slider</a></li>
                    <li><a href="tree_view.jsp">Tree View</a></li>
                    <li><a href="nestable.jsp">Nestable</a></li>
                    <li><a href="grids.jsp">Grids</a></li>
                    <li><a href="calendar.jsp">Calender</a></li>
                    <li><a href="draggable_portlet.jsp">Draggable Portlet</a></li>
                </ul>
            </li>
            <li>
                <a href="fontawesome.jsp">
            ...
            <li class="sub-menu">
                ...
                <ul class="sub">
                    ...
                    <li><a href="dynamic_table.jsp">Dynamic Table</a></li>
                    <li><a href="editable_table.jsp">Editable Table</a></li>
                </ul>
            </li>
            <li class="sub-menu">
                ...
                <ul class="sub">
                    <li><a href="form_component.jsp">Form Elements</a></li>
                    <li class="active"><a href="advanced_form.jsp">Advanced Components</a></li>
                    <li><a href="form_wizard.jsp">Form Wizard</a></li>
                    <li><a href="form_validation.jsp">Form Validation</a></li>
                    <li><a href="file_upload.jsp">Muliple File Upload</a></li>
                    
                    <li><a href="dropzone.jsp">Dropzone</a></li>
            ...
            <li class="sub-menu">
                ...
                <ul class="sub">
                    ...
                    <li><a href="mail_view.jsp">View Mail</a></li>
                </ul>
            </li>
            <li class="sub-menu">
                <a href="javascript:;">
                ...
                <ul class="sub">
                    ...
                    <li><a href="flot_chart.jsp">Flot Charts</a></li>
                    <li><a href="c3_chart.jsp">C3 Chart</a></li>
                </ul>
            </li>
            <li class="sub-menu">
                <a href="javascript:;">
                ...
                <ul class="sub">
                    <li><a href="google_map.jsp">Google Map</a></li>
                    <li><a href="vector_map.jsp">Vector Map</a></li>
                </ul>
            </li>
            <li class="sub-menu">
                <a href="javascript:;">
...
<li><a href="gallery.jsp">Media Gallery</a></li><li><a href="404.jsp">404 Error</a></li>
                ...
                <section class="panel">
                    ...
                    <div class="panel-body toggle-heading">
                        ...
                        <div class="m-bot20">
                            ...
                            <br>
                            <br>
                            <button id="btn-size-large-switch" class="btn btn-default btn-xs">Large</button>
                            <button id="btn-size-regular-switch" class="btn btn-default btn-xs">Regular</button>
                            <button id="btn-size-small-switch" class="btn btn-default btn-xs">Small</button>
                            <button id="btn-size-mini-switch" class="btn btn-default btn-xs">Mini</button>
                            <br>
                        </div>
                        ...
                        <div class="m-bot20">
                            ...
                            <br>
                            <br>
                            <button id="btn-color-on-switch" class="btn btn-success btn-xs">Change ON color</button>
                            <button id="btn-color-off-switch" class="btn btn-danger btn-xs">Change OFF color</button>
                        </div>
                        ...
                        <div class="row m-bot20">
                            <div class="col-md-6">
                                ...
                                <div class="">
                                    ...
                                    <br>
                                    <br>
                                    <button id="btn-animate-switch" class="btn btn-default btn-xs">Animate</button>
                                    <button id="btn-dont-animate-switch" class="btn btn-default btn-xs">Don't animate</button>
                                </div>
                            </div>
                        ...
                        <div class="row m-bot20">
                            <div class="col-md-6">
                                ...
                                <div class="">
                                    ...
                                    <br>
                                    <br>
                                    <button id="btn-label-on-switch" class="btn btn-default btn-xs">Change "On" label</button>
                                    <button id="btn-label-off-switch" class="btn btn-default btn-xs">Change "Off" label</button>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h3>HTML Text</h3>
                                <div class="">
                                    <input type="checkbox" checked data-on-label="<i class='fa fa-check'></i>" data-off-label="<i class='fa fa-times'></i>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="">
                                    Standard <input type="checkbox" checked class="switch-large" data-label-icon="fa fa-arrows-alt" data-on-label="<i class='fa fa-check'></i>" data-off-label="<i class='fa fa-times'></i>"> &nbsp;&nbsp;
                                    Font Awesome <input type="checkbox" checked class="switch-large" data-label-icon="fa fa-youtube-square" data-on-label="<i class='fa fa-hand-o-up'></i>" data-off-label="<i class='fa fa-hand-o-down'></i>"> &nbsp;&nbsp;
                                </div>
                            </div>
                        </div>
