...
<li><a href="typography.jsp">Typography</a></li>
            ...
            <li class="sub-menu">
                ...
                <ul class="sub">
                    <li class="active"><a href="mail.jsp">Inbox</a></li>
                ...
                <section class="panel">
                    <div class="panel-body">
                        ...
                        <ul class="nav nav-pills nav-stacked mail-nav">
                            <li class="active"><a href="mail.jsp"> <i class="fa fa-inbox"></i> Inbox  <span class="label label-danger pull-right inbox-notification">9</span></a></li>
                ...
                <section class="panel">
                    ...
                    <div class="panel-body minimal">
                        ...
                        <tr class="unread">
                            ...
                            <td class="view-message  dont-show"><a href="mail_view.jsp">ABC Company</a></td>
                            <td class="view-message "><a href="mail_view.jsp">Lorem ipsum dolor imit set.</a></td>
                        ...
                        <tr class="unread">
                            ...
                            <td class="inbox-small-cells"><i class="fa fa-star"></i></td>
                            <td class="view-message dont-show"><a href="mail_view.jsp">Mr Bean</a></td>
                            <td class="view-message"><a href="mail_view.jsp">Hi Bro, Lorem ipsum dolor imit</a></td>
                        ...
                        <tr class="">
                            ...
                            <td class="inbox-small-cells"><i class="fa fa-star"></i></td>
                            <td class="view-message dont-show"><a href="mail_view.jsp">Jonathan Smith</a></td>
                            <td class="view-message"><a href="mail_view.jsp">Lorem ipsum dolor sit amet</a></td>
                            <td class="view-message inbox-small-cells"></td>
                        ...
                        <tr class="">
                            ...
                            <td class="inbox-small-cells"><i class="fa fa-star"></i></td>
                            <td class="view-message dont-show"><a href="mail_view.jsp">Facebook</a></td>
                            <td class="view-message"><a href="mail_view.jsp">Dolor sit amet, consectetuer adipiscing</a></td>
                            <td class="view-message inbox-small-cells"></td>
                        ...
                        <tr class="">
                            ...
                            <td class="view-message dont-show"><a href="mail_view.jsp">Tasi man <span class="label label-danger pull-right">urgent</span></a></td>
                            <td class="view-message"><a href="mail_view.jsp">Lorem ipsum dolor sit amet</a></td>
                            <td class="view-message inbox-small-cells"></td>
